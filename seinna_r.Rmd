...
lm
```
Miðað við að p-gildið úr fyrrgreindu prófi er `r lm$p.value` sem er minna en 0.05 að þá getum við ályktað að dreifnin sé ólík.
...
$$
Gildið á prófstærðinni er 7.8033 og p-gildið er 0.0004979. Fyrst að prófstærðin er greinilega stærri en p-gildið að þá höfnum við $H_0$ og ályktum að a.m.k eitt meðaltal sé frábrugðið hinum.
...
kaupverd og birmt2 eru báðar samfelldar talnabreytur og því er viðeigandi að nota punktarit hér.
```{r}
